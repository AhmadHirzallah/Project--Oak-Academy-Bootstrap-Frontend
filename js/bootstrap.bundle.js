...
(function (global, factory) {
	...
	class Config {
		...
		_typeCheckConfig(config, configTypes = this.constructor.DefaultType) {
			for (const [property, expectedTypes] of Object.entries(
				...
				const valueType =
					isElement$1(value) ? "element" : toType(value);
	...
	class Carousel extends BaseComponent {
		...
		_slide(order, element = null) {
			...
			const directionalClassName =
				isNext ? CLASS_NAME_START : CLASS_NAME_END;
  ...
  */
	...
	function computeOffsets(_ref) {
		...
		var mainAxis =
			basePlacement ? getMainAxisFromPlacement(basePlacement) : null;
	...
	function detectOverflow(state, options) {
		...
		var _options = options,
			...
			boundary =
				_options$boundary === void 0 ? clippingParents : (
					_options$boundary
				),
			_options$rootBoundary = _options.rootBoundary,
			rootBoundary =
				_options$rootBoundary === void 0 ? viewport : (
					_options$rootBoundary
				),
			_options$elementConte = _options.elementContext,
			elementContext =
				_options$elementConte === void 0 ? popper : (
	...
	function computeAutoPlacement(state, options) {
		...
		var _options = options,
			...
			allowedAutoPlacements =
				_options$allowedAutoP === void 0 ? placements : (
	...
	function flip(_ref) {
		...
		for (var i = 0; i < placements.length; i++) {
			...
			var mainVariationSide =
				isVertical ?
					isStartVariation ? right
					:	left
			...
			var offsetModifierValue =
				(
					(_offsetModifierState$ =
						offsetModifierState == null ? void 0 : (
	...
	function popperGenerator(generatorOptions) {
		...
		var _generatorOptions = generatorOptions,
			...
			defaultOptions =
				_generatorOptions$def2 === void 0 ? DEFAULT_OPTIONS : (
		...
		return function createPopper(reference, popper, options) {
			...
			var instance = {
				...
				setOptions: function setOptions(setOptionsAction) {
					...
					state.scrollParents = {
						reference:
							isElement(reference) ? listScrollParents(reference)
	...
	class Dropdown extends BaseComponent {
		...
		static dataApiKeydownHandler(event) {
			...
			const getToggleButton =
				this.matches(SELECTOR_DATA_TOGGLE$3) ? this : (
